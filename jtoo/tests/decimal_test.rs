use jtoo::{Decimal, Decoder, Encode, EncodeError, Encoder};
...
fn append() {
    for (decimal, string) in [
        ...
        (Decimal::new(0, 3), "0.0"),
        (Decimal::new(0, 4), "0.0"),
        (Decimal::new(1, 1), "10.0"),
        (Decimal::new(1, 2), "100.0"),
        (Decimal::new(1, 3), "1_000.0"),
        (Decimal::new(1, 4), "10_000.0"),
        (Decimal::new(1, 5), "100_000.0"),
        (Decimal::new(1, 6), "1_000_000.0"),
        (Decimal::new(1, 7), "10_000_000.0"),
        (Decimal::new(-1, 7), "-10_000_000.0"),
        (Decimal::new(12, 7), "120_000_000.0"),
        (Decimal::new(123, 7), "1_230_000_000.0"),
        (Decimal::new(1234, 7), "12_340_000_000.0"),
        (Decimal::new(-1234, 7), "-12_340_000_000.0"),
        // Exponent is zero.
        (Decimal::new(1, 0), "1.0"),
        (Decimal::new(-1, 0), "-1.0"),
...
fn in_list() {
    ...
    encoder.append_decimal(Decimal::new(3, 2)).unwrap();
